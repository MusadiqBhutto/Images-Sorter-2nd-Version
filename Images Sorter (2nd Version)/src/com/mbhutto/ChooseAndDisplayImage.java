...
public class ChooseAndDisplayImage
{
        ...
        public void displayImages(String sortBy, String OrderBy)
        {
            ...
            else
            {
                ...
                {
                    sortedImageFiles[i] = new File(String.valueOf(choosedImageFiles[i]));
                }

                Sorting sorting = new Sorting(sortBy, OrderBy,sortedImageFiles);
                sortedImageFiles = sorting.getSorted();
        ...
        private void setChoosedImageFiles(File[] files)
        {
